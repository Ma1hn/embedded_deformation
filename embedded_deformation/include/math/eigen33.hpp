#pragma once
#include "imageProcessor/common_utils.h"
#include "math/eigen33.h"
#include "math/vector_ops.hpp"

__host__ __device__ __forceinline__ void eigen33::compute_root2(const float b, const float c, float3 & roots)
{
...
__host__ __device__ __forceinline__ float3 eigen33::unit_orthogonal(const float3 & src)
{
	float3 perp;
...
__host__ __device__ __forceinline__ void eigen33::compute_root3(const float c0, const float c1, const float c2, float3 & roots)
{
...
__host__ __device__ __forceinline__ void eigen33::compute(Mat33 & tmp, Mat33 & vec_tmp, Mat33 & evecs, float3 & evals)
{
...
__host__ __device__ __forceinline__ void eigen33::compute(float3 & eigen_vec)
{
...
__host__ __device__ __forceinline__ void eigen33::compute(float3 & eigen_vec, float& eigen_value)
{
	Mat33 tmp, vec_tmp, evecs;
	float3 evals;
	compute(tmp, vec_tmp, evecs, evals);
